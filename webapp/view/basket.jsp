...
<%
    ...
    if (user.getProductList().isEmpty()) {
        request.setAttribute("grantButton", "hidden");
    } else {
        request.setAttribute("grantButton", "visible");
    }
%>
...
<div class="container p-3 my-3">
    <a type="button" style="visibility:${grantButton}" class="btn btn-dark btn-lg"
       href="${pageContext.request.contextPath}/pay">Grant</a>
